...
export default function EmployeeDashboard() {
  ...
  const getTaskCounts = (empId) => {
    ...
    return { started, pending, completed, total: started+ pending +completed};
  };
  ...
  const EmployeeDetailModal = ({ employee, isOpen, onClose }) => {
    ...
    const tasksByStatus = {
      ...
      completed: employeeTasks.filter((task) => (task.status === "completed") && (task.completed_at === selectedDate)),
    };
        ...
        <div className="mb-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex flex-col sm:flex-row gap-4 w-full">
              ...
              {!showByDate ? (
                <button onClick={handleShowDate}>Date Filter</button>
              ) : (
                <>
...
//   // Get task counts by status for an employee
//   const getTaskCounts = (empId) => {
//     const tasks = assignedTasks.filter((task) => task.assigned_to === empId);
...
//           <div className="grid grid-cols-3 gap-2 text-sm">
//             <div className="text-center p-1 bg-yellow-50 rounded text-yellow-700">
//               <span className="font-semibold">{started}</span> Started
//             </div>
//             <div className="text-center p-1 bg-red-50 rounded text-red-700">
//               <span className="font-semibold">{pending}</span> Pending
//             </div>
